...
#project_dir = '/home/usr/work_unix/IBM/vi_edge_tt_zd/pred/AX_zd_scratchmix/test/'
...
gtFolder = os.path.join(project_dir, model_dir, 'ground-truth')
detFolder = os.path.join(project_dir, model_dir, 'detection-results')
# 模型的输出结果，
savePath = os.path.join(project_dir, model_dir, 'evaluation-results')
